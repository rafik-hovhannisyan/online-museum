...
//        StringBuilder sb = new StringBuilder("to get artists of \"{}\" from page {}");
//        if (!artistSearchCriteria.getFullName().isEmpty() || artistSearchCriteria.getBirthYearFrom() != null
//                || artistSearchCriteria.getBirthYearTo() != null || !artistSearchCriteria.getStyle().isEmpty()) {
//            sb.append(" with filtered fields");
//        }
//
//        logger.info("Received a request " + sb.toString() + ".",
//                sphere, artistSearchCriteria.getPageNumber());
        GenericPageableResponse<ArtistDto> artists = artistService.getArtistsOfSphere(sphere, artistSearchCriteria);

//        logger.info("The request " + sb.toString() + "has successfully done.",
//                sphere, artistSearchCriteria.getPageNumber());
